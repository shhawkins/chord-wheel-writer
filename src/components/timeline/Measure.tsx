...
export const Measure: React.FC<MeasureProps> = ({ measure, sectionId, index, chordSize = 48 }) => {
    return (
        <div className="flex flex-col border-r border-border-subtle last:border-r-0 px-1">
